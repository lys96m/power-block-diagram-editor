                  ...
                  return (
                    <Stack spacing={1}>
                      ...
                      <TextField
                        ...
                        onChange={(e) =>
                          handleTypeCRatingChange("in", "V_in", toNumberOrUndefined(e.target.value))
                        }
                      />
                      <TextField
                        size="small"
                        ...
                        onChange={(e) =>
                          handleTypeCRatingChange("in", "I_in_max", toNumberOrUndefined(e.target.value))
                        }
                      />
                      <TextField
                        size="small"
                        ...
                        onChange={(e) =>
                          handleTypeCRatingChange("in", "P_in_max", toNumberOrUndefined(e.target.value))
                        }
                      />
                      <TextField
                        size="small"
                      ...
                      <TextField
                        ...
                        onChange={(e) =>
                          handleTypeCRatingChange("out", "V_out", toNumberOrUndefined(e.target.value))
                        }
                      />
                      <TextField
                        size="small"
                      ...
                      <TextField
                        ...
                        value={rating.eta ?? ""}
                        onChange={(e) =>
                          handleTypeCRatingChange("eta", "eta", toNumberOrUndefined(e.target.value))
                        }
                      />
                    </Stack>
                  );
